namespace LuckySlots.Services.Tests.GameStatsServicesTests
{
    ...
    [TestClass]
    public class GetPaidOutAmountByGame_Should
    {
        ...
        [TestMethod]
        public async Task Returns_ProperSum_OfWinGames()
        {
            var options = GetDbContextOptions("Returns_ProperSum_OfWinGames");
            ...
            using (var assertContext = new LuckySlotsDbContext(options))
            {
                ...
                var result = sut.GetPaidOutAmountByGame(gameName);
